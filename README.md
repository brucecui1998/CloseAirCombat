...
- **Usage**: 
```bash
bash train_selfplay.sh --eval-render-mode history_acmi --eval-interval 10 --use-eval
```
...
- **Usage**: 
```bash
bash train_selfplay.sh --eval-render-mode real_time --use-eval --eval-interval 10 --use-eval
```
